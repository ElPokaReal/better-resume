      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-6xl sm:text-7xl lg:text-[5.5rem] font-medium mb-6 leading-[1.1] tracking-tight">
            Crea currículums que
            <br />
            destacan instantáneamente
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Diseñado para hacerte extraordinariamente productivo, Better Resume es la mejor forma de crear tu CV profesional.
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-500 mb-6">
            Usado cada día por miles de profesionales.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-medium mb-4">
                Plantillas que impresionan
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                Diseños profesionales creados por expertos. Optimizados para destacar ante reclutadores.
              </p>
              <Link
                href="/templates"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-4xl font-medium mb-4">
                Edición ultrarrápida
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                Completa tu currículum en minutos con nuestra interfaz intuitiva. Cambios en tiempo real.
              </p>
              <Link
                href="/features"
                className="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                Exporta en PDF de alta calidad. Compatible con sistemas ATS y listo para compartir con empleadores.
              </p>
              <Link
                href="/features"
                className="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
              ...
              <div className="relative bg-gray-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-black border border-gray-200 dark:border-white/10 rounded-xl p-8">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-600 dark:text-gray-400">Mi_Curriculum.pdf</div>
                    <div className="text-xs text-green-500">✓ Listo</div>
                  </div>
                  <div className="h-32 bg-gray-100 dark:bg-white/5 rounded border border-gray-200 dark:border-white/10 flex items-center justify-center">
                    <div className="text-center space-y-2">
                      ...
                      <div className="text-xs text-gray-500">Vista previa PDF</div>
                    </div>
                  </div>
